...
metadata {
definition (name: "Vision Dual Relay", namespace: "NomadTech", author: "Daniel Ionescu") {
capability "Switch"
capability "Polling"
...
tiles {
	...
	preferences {
        input "deviceType", "enum", title: "Switch Model", defaultValue: "3", displayDuringSetup: true, required: false, options: [
                "1":"Philio",
                "2":"Enerwave",
                "3":"Vision"]
  }
...
def configure() {
    ...
    switch (deviceType.value as String) {
       ...
       break
       case "3":
       log.debug "Configuring device as Vision"
       break
       default:
