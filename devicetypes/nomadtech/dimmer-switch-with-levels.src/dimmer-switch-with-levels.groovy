	 ...
	 * pmjoen@yahoo.com
	 * 20160517
	 * v1.6 - Fixed Adjusting transition.
	...
	metadata {
		...
		definition (name: "Dimmer Switch with Levels", namespace: "NomadTech", author: "SmartThings") {
	...
	def doCreateEvent(physicalgraph.zwave.Command cmd, Map item1) {
		...
		if (item1.value == "off") {sendEvent(name: "currentState", value: "OFF" as String)}
...
//            sendEvent(name: "currentState", value: "default" as String)
