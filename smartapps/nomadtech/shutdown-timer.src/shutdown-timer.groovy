...
definition(
    ...
    description: "Turns OFF an appliance after a preset time.  When a switch turns on, automatically turn it back off after a set number of minutes you specify.",
